  ...
  return {
    ...
    pre() {
      ...
      if (runtime !== undefined) {
        if (
          file.has(_features.runtimeKey) &&
          file.get(_features.runtimeKey) !== runtime &&
          (0, _features.hasFeature)(
            newFeatures,
            _features.FEATURES.duplicateNamedCaptureGroups
          )
        ) {
          throw new Error(
        ...
        if (feature === "namedCaptureGroups") {
          if (!runtime || !file.has(_features.runtimeKey))
    ...
    visitor: {
      RegExpLiteral(path) {
        ...
        node.flags = (0, _util.transformFlags)(
          regexpuOptions,
          newFlags != null ? newFlags : node.flags
        );
      },
    },
  };
