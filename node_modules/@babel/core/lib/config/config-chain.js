...
const loadPresetOverridesDescriptors = (0, _caching.makeWeakCache)((preset) =>
...
const loadFileOverridesDescriptors = (0, _caching.makeWeakCache)((file) =>
  (0, _caching.makeStrongCache)((index) =>
    buildOverrideDescriptors(
      file,
      file.filepath,
...
const loadFileOverridesEnvDescriptors = (0, _caching.makeWeakCache)((file) =>
  (0, _caching.makeStrongCache)((index) =>
    (0, _caching.makeStrongCache)((envName) =>
      buildOverrideEnvDescriptors(
        file,
