        ...
        visitRestElements(path.get("id"), (path) => {
          ...
          if (
            ...
            originalPath.insertBefore(
              _core().types.variableDeclarator(initRef, originalPath.node.init)
            );
        ...
        if (leftPath.isObjectPattern() && hasRestElement(leftPath)) {
          ...
          nodes.push(
            _core().types.toStatement(
              _core().types.assignmentExpression("=", argument, callExpression)
            )
          );
          nodes.push(
            _core().types.expressionStatement(_core().types.identifier(refName))
          );
