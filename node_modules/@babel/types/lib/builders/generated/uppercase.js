...
const ArrayExpression = (exports.ArrayExpression = alias("arrayExpression")),
  ...
  FunctionExpression = (exports.FunctionExpression = alias(
    "functionExpression"
  )),
  ...
  SequenceExpression = (exports.SequenceExpression = alias(
    "sequenceExpression"
  )),
  ...
  VariableDeclarator = (exports.VariableDeclarator = alias(
    "variableDeclarator"
  )),
  ...
  ClassPrivateMethod = (exports.ClassPrivateMethod = alias(
    "classPrivateMethod"
  )),
  ...
  BooleanLiteralTypeAnnotation = (exports.BooleanLiteralTypeAnnotation = alias(
  ...
  DeclareExportAllDeclaration = (exports.DeclareExportAllDeclaration = alias(
  ...
  IntersectionTypeAnnotation = (exports.IntersectionTypeAnnotation = alias(
  ...
  NumberLiteralTypeAnnotation = (exports.NumberLiteralTypeAnnotation = alias(
  ...
  ObjectTypeProperty = (exports.ObjectTypeProperty = alias(
    "objectTypeProperty"
  )),
  ...
  StringLiteralTypeAnnotation = (exports.StringLiteralTypeAnnotation = alias(
  ...
  ThisTypeAnnotation = (exports.ThisTypeAnnotation = alias(
    "thisTypeAnnotation"
  )),
  ...
  TypeCastExpression = (exports.TypeCastExpression = alias(
    "typeCastExpression"
  )),
  ...
  TypeParameterInstantiation = (exports.TypeParameterInstantiation = alias(
  ...
  VoidTypeAnnotation = (exports.VoidTypeAnnotation = alias(
    "voidTypeAnnotation"
  )),
  ...
  JSXEmptyExpression = (exports.JSXEmptyExpression = alias(
    "jsxEmptyExpression"
  )),
  ...
  JSXSpreadAttribute = (exports.JSXSpreadAttribute = alias(
    "jsxSpreadAttribute"
  )),
  JSXText = (exports.JSXText = alias("jsxText")),
  JSXFragment = (exports.JSXFragment = alias("jsxFragment")),
  JSXOpeningFragment = (exports.JSXOpeningFragment = alias(
    "jsxOpeningFragment"
  )),
  JSXClosingFragment = (exports.JSXClosingFragment = alias(
    "jsxClosingFragment"
  )),
  ...
  PipelinePrimaryTopicReference = (exports.PipelinePrimaryTopicReference = alias(
  ...
  TSCallSignatureDeclaration = (exports.TSCallSignatureDeclaration = alias(
    "tsCallSignatureDeclaration"
  )),
  TSConstructSignatureDeclaration = (exports.TSConstructSignatureDeclaration = alias(
  ...
  TSIntrinsicKeyword = (exports.TSIntrinsicKeyword = alias(
    "tsIntrinsicKeyword"
  )),
  ...
  TSUndefinedKeyword = (exports.TSUndefinedKeyword = alias(
    "tsUndefinedKeyword"
  )),
  ...
  TSNamedTupleMember = (exports.TSNamedTupleMember = alias(
    "tsNamedTupleMember"
  )),
  TSUnionType = (exports.TSUnionType = alias("tsUnionType")),
  TSIntersectionType = (exports.TSIntersectionType = alias(
    "tsIntersectionType"
  )),
  ...
  TSExpressionWithTypeArguments = (exports.TSExpressionWithTypeArguments = alias(
  ...
  TSExportAssignment = (exports.TSExportAssignment = alias(
    "tsExportAssignment"
  )),
  TSNamespaceExportDeclaration = (exports.TSNamespaceExportDeclaration = alias(
    "tsNamespaceExportDeclaration"
  )),
  TSTypeAnnotation = (exports.TSTypeAnnotation = alias("tsTypeAnnotation")),
  TSTypeParameterInstantiation = (exports.TSTypeParameterInstantiation = alias(
    "tsTypeParameterInstantiation"
  )),
  TSTypeParameterDeclaration = (exports.TSTypeParameterDeclaration = alias(
