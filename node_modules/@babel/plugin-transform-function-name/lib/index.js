...
var _default = (exports.default = (0, _helperPluginUtils.declare)((api) => {
  api.assertVersion(7);
  const supportUnicodeId = !(0, _helperCompilationTargets.isRequired)(
        ...
        if (value.isFunction()) {
          {
            ...
            (_value$ensureFunction = value.ensureFunctionName) != null
              ? _value$ensureFunction
              : (value.ensureFunctionName = require("@babel/traverse").NodePath.prototype.ensureFunctionName);
          }
